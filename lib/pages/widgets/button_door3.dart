...
class ButtonDoor3 extends StatelessWidget with BluetoothConnectionMixin {
  final String name;
  final String surname;
  final String title;
  const ButtonDoor3({super.key, required this.title, required this.name, required this.surname});
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          await checkConnectionAndNotify(
            context,
            commandPayload,
            "Вход в помещение третьего уровня доступен",
          );
        },
